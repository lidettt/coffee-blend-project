  ...
  <body>
    <section class="hero">
      <div class="overlay">
        ...
        <div class="home-contact">
          ...
          <a class="color-standing" href="contact.php">CONTACT</a>
        </div>
      </div>
    </section>
    ...
    <section class="contact">
      <div class="contact-info">
        ...
        <p>
          <strong>Address:</strong> 198 West 21th Street, Suite 721 New York, NY
          10016
        </p>
        <p>
          <strong>Phone:</strong> <a href="tel:+1235235598">+ 1235 2355 98</a>
        </p>
        <p>
          <strong>Email:</strong>
