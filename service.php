    ...
    <section class="hero">
      <div class="content">
        ...
        <div class="home-service">
          ...
          <a class="color-standing" href="service.php">SERVICES</a>
        </div>
      </div>
    </section>

    <!-- Service Yellow Box -->
    <section class="service-info-background">
      <div class="default-padding service-info">
        <div class="service-info-container">
          <img src="images/service_1.png" alt="" />
          <p class="service-title">EASY TO ORDER</p>
        ...
        <div class="service-info-container">
          ...
          <p class="service-title">FASTEST DELIVERY</p>
          <p class="service-description">
            Even the all-powerful Pointing has no control about the blind texts
            it is an almost unorthographic.
          </p>
        ...
        <div class="service-info-container">
          ...
          <p class="service-title">QUALITY COFFEE</p>
          <p class="service-description">
            Even the all-powerful Pointing has no control about the blind texts
            it is an almost unorthographic.
          </p>
